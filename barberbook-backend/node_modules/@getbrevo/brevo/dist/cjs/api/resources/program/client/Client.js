...
class ProgramClient {
     ...
     */
    getLpList(request = {}, requestOptions) {
    ...
    __getLpList() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/loyalty/config/programs");
        });
    }
    /**
    ...
    __createNewLp(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/loyalty/config/programs");
        });
    }
    /**
    ...
    __getLoyaltyProgramInfo(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/loyalty/config/programs/{pid}");
        });
    }
    /**
    ...
    __updateLoyaltyProgram(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "PUT", "/loyalty/config/programs/{pid}");
        });
    }
    /**
    ...
    __deleteLoyaltyProgram(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "DELETE", "/loyalty/config/programs/{pid}");
        });
    }
    /**
     ...
     *     })
     */
    partiallyUpdateLoyaltyProgram(request, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__partiallyUpdateLoyaltyProgram(request, requestOptions));
    }
    __partiallyUpdateLoyaltyProgram(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j;
            const { pid } = request, _body = __rest(request, ["pid"]);
            const _authRequest = yield this._options.authProvider.getAuthRequest();
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "PATCH", "/loyalty/config/programs/{pid}");
        });
    }
    /**
     ...
     *     })
     */
    getParameterSubscriptionInfo(request, requestOptions) {
    ...
    __getParameterSubscriptionInfo(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/loyalty/config/programs/{pid}/account-info");
        });
    }
    /**
    ...
    __deleteContactSubscription(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "DELETE", "/loyalty/config/programs/{pid}/contact/{cid}");
        });
    }
    /**
    ...
    __publishLoyaltyProgram(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/loyalty/config/programs/{pid}/publish");
        });
    }
    /**
     ...
     *     })
     */
    subscribeMemberToASubscription(request, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__subscribeMemberToASubscription(request, requestOptions));
    }
    __subscribeMemberToASubscription(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j;
            const { pid } = request, _body = __rest(request, ["pid"]);
            const _authRequest = yield this._options.authProvider.getAuthRequest();
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/loyalty/config/programs/{pid}/subscription-members");
        });
    }
    /**
    ...
    __deleteContactMembers(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "DELETE", "/loyalty/config/programs/{pid}/subscription-members");
        });
    }
    /**
    ...
    __subscribeToLoyaltyProgram(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j;
            const { pid } = request, _body = __rest(request, ["pid"]);
            const _authRequest = yield this._options.authProvider.getAuthRequest();
            const _headers = (0, headers_js_1.mergeHeaders)(_authRequest.headers, (_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield core.fetcher({
                url: core.url.join((_c = (_b = (yield core.Supplier.get(this._options.baseUrl))) !== null && _b !== void 0 ? _b : (yield core.Supplier.get(this._options.environment))) !== null && _c !== void 0 ? _c : environments.BrevoEnvironment.Default, `loyalty/config/programs/${core.url.encodePathParam(pid)}/subscriptions`),
                method: "POST",
                headers: _headers,
                contentType: "application/json",
                queryString: core.url.queryBuilder().mergeAdditional(requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.queryParams).build(),
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/loyalty/config/programs/{pid}/subscriptions");
        });
    }
}
