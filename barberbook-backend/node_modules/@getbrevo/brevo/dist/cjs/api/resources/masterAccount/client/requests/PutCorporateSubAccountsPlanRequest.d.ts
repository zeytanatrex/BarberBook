 ...
 *     }
 */
export interface PutCorporateSubAccountsPlanRequest {
    /** Credit details to update */
    credits?: PutCorporateSubAccountsPlanRequest.Credits;
    /** Features details to update */
    features?: PutCorporateSubAccountsPlanRequest.Features;
    /** List of sub-account ids */
    subAccountIds?: number[];
}
export declare namespace PutCorporateSubAccountsPlanRequest {
    /**
     * Credit details to update
     */
    interface Credits {
