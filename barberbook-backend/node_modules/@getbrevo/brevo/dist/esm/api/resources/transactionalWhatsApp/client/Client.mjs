...
export class TransactionalWhatsAppClient {
     ...
     *     })
     */
    sendWhatsappMessage(request, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__sendWhatsappMessage(request, requestOptions));
    }
    __sendWhatsappMessage(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j;
            const _authRequest = yield this._options.authProvider.getAuthRequest();
            const _headers = mergeHeaders(_authRequest.headers, (_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield core.fetcher({
                url: core.url.join((_c = (_b = (yield core.Supplier.get(this._options.baseUrl))) !== null && _b !== void 0 ? _b : (yield core.Supplier.get(this._options.environment))) !== null && _c !== void 0 ? _c : environments.BrevoEnvironment.Default, "whatsapp/sendMessage"),
                method: "POST",
                headers: _headers,
     ...
     */
    getWhatsappEventReport(request = {}, requestOptions) {
