...
export class UserClient {
     ...
     */
    getInvitedUsersList(requestOptions) {
    ...
    __putRevokeUserPermission(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "PUT", "/organization/user/invitation/revoke/{email}");
        });
    }
    /**
    ...
    __inviteuser(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j;
            const _authRequest = yield this._options.authProvider.getAuthRequest();
            const _headers = mergeHeaders(_authRequest.headers, (_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield core.fetcher({
                url: core.url.join((_c = (_b = (yield core.Supplier.get(this._options.baseUrl))) !== null && _b !== void 0 ? _b : (yield core.Supplier.get(this._options.environment))) !== null && _c !== void 0 ? _c : environments.BrevoEnvironment.Default, "organization/user/invitation/send"),
                method: "POST",
                headers: _headers,
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/organization/user/invitation/send");
        });
    }
    /**
    ...
    __putresendcancelinvitation(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "PUT", "/organization/user/invitation/{action}/{email}");
        });
    }
    /**
     * `Feature` - A Feature represents a specific functionality like Email
     ...
     *     })
     */
    editUserPermission(request, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__editUserPermission(request, requestOptions));
    }
    __editUserPermission(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j;
            const _authRequest = yield this._options.authProvider.getAuthRequest();
            const _headers = mergeHeaders(_authRequest.headers, (_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield core.fetcher({
                url: core.url.join((_c = (_b = (yield core.Supplier.get(this._options.baseUrl))) !== null && _b !== void 0 ? _b : (yield core.Supplier.get(this._options.environment))) !== null && _c !== void 0 ? _c : environments.BrevoEnvironment.Default, "organization/user/update/permissions"),
                method: "POST",
                headers: _headers,
                contentType: "application/json",
                queryString: core.url.queryBuilder().mergeAdditional(requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.queryParams).build(),
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/organization/user/update/permissions");
        });
    }
    /**
    ...
    __getUserPermission(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/organization/user/{email}/permissions");
        });
    }
}
